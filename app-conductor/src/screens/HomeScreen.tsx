...
const styles = StyleSheet.create({
  ...
  connectionText: { color: colors.inkSoft, fontFamily: fonts.body, fontSize: 9, fontWeight: '700' },
  heroPanel: {
    minHeight: 126,
  ...
  heroEyebrow: { color: 'rgba(255,255,255,0.8)', fontFamily: fonts.mono, fontSize: 8, fontWeight: '700', letterSpacing: 1.1 },
  heroTitle: { color: colors.white, fontFamily: fonts.display, fontSize: 27, lineHeight: 34, fontWeight: '600', marginTop: 2 },
  heroSubtitle: { color: 'rgba(255,255,255,0.82)', fontFamily: fonts.body, fontSize: 11, marginTop: 2 },
  heroBusBadge: {
    width: 70,
    height: 70,
    borderRadius: 22,
  ...
  searchInput: { flex: 1, height: '100%', paddingVertical: 0, color: colors.ink, fontFamily: fonts.body, fontSize: 14, fontWeight: '600' },
  sectionHeading: { marginBottom: spacing.sm },
  sectionKicker: { color: colors.primary, fontFamily: fonts.mono, fontSize: 8, fontWeight: '700', letterSpacing: 1.25 },
  sectionTitle: { color: colors.ink, fontFamily: fonts.display, fontSize: 19, lineHeight: 24, fontWeight: '600', marginTop: 1 },
  preferenceTabs: {
    height: 43,
    padding: 4,
    borderRadius: radii.lg,
  ...
  preferenceTabText: { color: colors.transitDark, fontFamily: fonts.body, fontSize: 11, fontWeight: '700' },
  preferenceTabTextActive: { color: colors.white },
  preferenceCount: { minWidth: 20, height: 20, borderRadius: 10, backgroundColor: colors.white, color: colors.transitDark, textAlign: 'center', lineHeight: 20, fontFamily: fonts.mono, fontSize: 9, fontWeight: '700' },
  ...
  preferenceCardTitle: { color: colors.ink, fontFamily: fonts.body, fontSize: 12, lineHeight: 16, fontWeight: '700' },
  preferenceCardMeta: { color: colors.muted, fontFamily: fonts.mono, fontSize: 9, marginTop: 3 },
  preferenceEmpty: {
    minHeight: 72,
    padding: spacing.md,
    borderRadius: radii.lg,
  ...
  preferenceEmptyText: { flex: 1, color: colors.inkSoft, fontFamily: fonts.body, fontSize: 11, lineHeight: 16 },
  operatorLabel: { color: colors.transitDark, fontFamily: fonts.mono, fontSize: 8, fontWeight: '700', letterSpacing: 1.2, marginBottom: spacing.sm },
  ...
  catalogButton: { height: 35, paddingHorizontal: spacing.md, borderRadius: radii.pill, backgroundColor: colors.primary, flexDirection: 'row', alignItems: 'center', gap: spacing.xs },
  catalogButtonText: { color: colors.white, fontFamily: fonts.body, fontSize: 10, fontWeight: '700' },
  routeList: { gap: spacing.sm },
  routeRow: { minHeight: 63, padding: spacing.sm, borderRadius: radii.lg, backgroundColor: colors.white, borderWidth: 1, borderColor: colors.border, flexDirection: 'row', alignItems: 'center' },
  ...
  routeBadgeText: { fontFamily: fonts.body, fontSize: 12, fontWeight: '800' },
  routeCopy: { flex: 1, minWidth: 0 },
  routeName: { color: colors.ink, fontFamily: fonts.body, fontSize: 12, fontWeight: '700' },
  routeMeta: { color: colors.muted, fontFamily: fonts.mono, fontSize: 9, marginTop: 2 },
  starButton: { width: 37, height: 37, borderRadius: 19, backgroundColor: colors.transitWash, alignItems: 'center', justifyContent: 'center' },
  starButtonActive: { backgroundColor: colors.primarySoft },
  loadingState: { minHeight: 100, alignItems: 'center', justifyContent: 'center' },
  loadingText: { color: colors.muted, fontFamily: fonts.body, fontSize: 11, marginTop: spacing.sm },
  emptyRoutes: { minHeight: 90, alignItems: 'center', justifyContent: 'center', borderRadius: radii.lg, backgroundColor: colors.white },
  emptyRoutesText: { color: colors.muted, fontFamily: fonts.body, fontSize: 11, marginTop: spacing.xs },
  servicePanel: {
    paddingHorizontal: spacing.lg,
  ...
  serviceKicker: { color: colors.transitDark, fontFamily: fonts.mono, fontSize: 8, fontWeight: '700', letterSpacing: 1.1 },
  serviceTitle: { color: colors.ink, fontFamily: fonts.body, fontSize: 12, fontWeight: '700', marginTop: 1 },
  ...
  serviceRouteBadgeText: { fontFamily: fonts.body, fontSize: 13, fontWeight: '800' },
  directionLabel: { color: colors.muted, fontFamily: fonts.body, fontSize: 10, fontWeight: '600', marginBottom: 5 },
  directionSelector: { padding: 4, borderRadius: radii.lg, backgroundColor: colors.transitWash, flexDirection: 'row', gap: 4, marginBottom: spacing.sm },
  directionSelectorLandscape: { flexDirection: 'column' },
  directionOption: { flex: 1, minHeight: 51, paddingHorizontal: spacing.sm, borderRadius: radii.md, flexDirection: 'row', alignItems: 'center', gap: spacing.sm },
  ...
  directionNumberText: { color: colors.transitDark, fontFamily: fonts.mono, fontSize: 10, fontWeight: '700' },
  directionNumberTextSelected: { color: colors.white },
  directionText: { flex: 1, color: colors.inkSoft, fontFamily: fonts.body, fontSize: 10, lineHeight: 14, fontWeight: '600' },
  directionTextSelected: { color: colors.ink },
  startButton: { minHeight: 55, paddingHorizontal: spacing.lg, borderRadius: radii.lg, backgroundColor: colors.primary, flexDirection: 'row', alignItems: 'center', gap: spacing.md },
  startButtonDisabled: { backgroundColor: '#A7B9BF' },
  startButtonCopy: { flex: 1, minWidth: 0 },
  startButtonText: { color: colors.white, fontFamily: fonts.body, fontSize: 14, fontWeight: '800' },
  startButtonMeta: { color: 'rgba(255,255,255,0.82)', fontFamily: fonts.body, fontSize: 9, marginTop: 1 },
});
